...
// invoke を引数で受けるのは、window も Tauri も無い node --test から回すため（frame.js と同じ）。
//
// Rust の引数名は snake_case だが、JS から渡す名前は Tauri が camelCase へ寄せた側。
...
//
// macOS の実機で 300 MiB を書いて測った結果、頭打ちはこの幅で来ている。
...
// Tauri の custom protocol IPC は一度失敗すると customProtocolIpcFailed が立ち、以降
