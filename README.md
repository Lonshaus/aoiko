...
<p align="center">
  <img src="docs/images/screenshot-home.png" alt="ホーム画面：今月の概況・新規仕訳フォーム・直近の仕訳" width="49%" />
  <img src="docs/images/screenshot-reports.png" alt="レポート画面：年間概況と月別売上" width="49%" />
</p>
...
操作手順は [docs/manual/](docs/manual/) を参照。初回設定・仕訳作成・CSV 取込・レポートを章ごとに説明（英語・繁體中文版もあり）。
