  ...
  const out = mapKoa210Values(
    ctx({
      bs: {
        ...
        asOf: '2026-12-31',
        assets: [
          { accountName: '現金', balance: '100000' },
          { accountName: '普通預金', balance: '500000' },
          { accountName: '工具器具備品', balance: '300000' },
        ],
        liabilities: [{ accountName: '買掛金', balance: '80000' }],
        equity: [{ accountName: '元入金', balance: '700000' }],
        netIncome: '0',
        totalAssets: '900000',
